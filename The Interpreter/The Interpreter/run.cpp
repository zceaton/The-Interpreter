...
int main(int argc, char *argv[]) {
	Interpreter i;
	//vector<string> v = i.infixToPostfix("(100-(x+y))*15-20/(5-4)");
	//for (size_t x = 0; x < v.size(); x++) { cout << v[x] << " "; }
	//cout << i.correctSpacing("(100-(x+y))*15-20/(5-4)") << endl;
	cout << i.computeInfix("5+ 7") << endl;
